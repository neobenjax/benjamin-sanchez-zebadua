      ...
      <div className="max-w-7xl mx-auto px-8 lg:px-8">
        <div className="flex items-center justify-between h-20">
          <div className="flex-shrink flex-1 max-w-[75%] sm:max-w-none mr-4">
            <Link href="/" className="text-[clamp(0.85rem,2.5vw,1.25rem)] leading-tight tracking-normal md:tracking-wide lg:tracking-[0.2em] text-white font-semibold flex flex-wrap items-center">
