      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          ...
          <div className="flex flex-col md:items-end justify-end space-y-4">
            <div className="font-serif text-xl tracking-widest text-white font-semibold opacity-50 mb-4">
              BENJAMIN <span className="font-sans tracking-normal mx-1">//</span> STRATEGIST
            </div>
            {/* FOOTER GROUNDING */}
            <div className="text-gray-400 text-right text-sm">
              <span className="block mb-1 text-white/80 font-medium">Based in Ottawa, ON</span>
              Open to remote and local opportunities in FinTech and Financial Strategy.
            </div>
          </div>
        </div>
